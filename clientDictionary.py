...
class game_grid():
    ...
    def __init__(self,x,y,key,location,setcolor):
        self.x = x
        self.y = y
        self.key = key
        self.location = location
        self.color = setcolor
        self.initalcolor = setcolor
...
def main():
    ...
    pygame.display.set_caption("Admerial Acknowledge")
